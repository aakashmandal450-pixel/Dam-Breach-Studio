...
const APP_NAME = "Dam Breach Studio";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Mechanistic dam-breach formation studio: physically based erosion, hydrographs, and installable desktop use.",
      },
      { name: "theme-color", content: "#245460" },
    ],
    links: [
